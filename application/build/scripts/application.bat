...
set CLASSPATH=%APP_HOME%\lib\application-1.0.jar

@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" com.test.java.features.main.Main %CMD_LINE_ARGS%
